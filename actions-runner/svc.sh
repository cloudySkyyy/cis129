...
SVC_NAME="actions.runner.songhachheo-cis129-programming-logic.SongsMacbookPro"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (songhachheo-cis129-programming-logic.SongsMacbookPro)"
